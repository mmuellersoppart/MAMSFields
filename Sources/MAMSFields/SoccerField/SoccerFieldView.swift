...
public struct SoccerFieldView: View {
    ...
    public var body: some View {
        ...
        Canvas { context, size in
            ...
            let scaleToFit = Field.determineFieldScale(totalFieldSize: Size2D(x: SoccerFieldConstants.totalW, y: SoccerFieldConstants.totalH), boundarySize: size.asSize2D, rotation: radians)
...
struct SoccerFieldView_Previews: PreviewProvider {
    static var previews: some View {
        SoccerFieldView(radians: Double.pi/2)
    }
}
